...
describe("Balancer V2 Price Oracle", function () {
    ...
    it("Should be able to initialize", async function () {
        ...
        (0, chai_1.expect)(await oracle.vault()).to.equal(
            addressRegistry.BEETHOVEN_VAULT
        );
    });
    ...
    describe("After initialization", function () {
        ...
        it("Architect can set oracle settings", async function () {
            ...
            (0, chai_1.expect)(await oracle.tokenPools(addressRegistry.BEETS)).to.equal(
                addressRegistry.FIDELIO_DUETTO
            );
            (0, chai_1.expect)(
                await oracle.denominatedOracles(addressRegistry.BEETS)
            ).to.equal(utils_1.ZERO_ADDRESS);
        });
