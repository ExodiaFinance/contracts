...
exports.ETH_ADDRESS = "0x74b23882a30290451A17c44f4F05243b6b58C76d";
exports.BEETHOVEN_SUBGRAPH =
...
describe("Beethoven X token spot price oracle V2", function () {
    ...
    it("Should get the price of 1 token with 8 decimals for equal weights", async function () {
        ...
        const oracle = typechain_1.BalV2SpotPriceOracle__factory.connect(
        ...
        (0, chai_1.expect)(ftmPrice).to.be.closeTo(ftmOracle, 5e7);
    });
    it("Should get the price of 1 token with 8 decimals for unequal weights", async function () {
        ...
        (0, chai_1.expect)(price).to.be.closeTo(ethers_1.BigNumber.from(1e8), 5e7);
    });
    it("Should deploy EXOD price oracle", async function () {
        ...
        (0, chai_1.expect)(price).to.be.closeTo(exodPrice, 1e7);
    });
    it("BalV2SpotPriceOracle should only let policy call setup", async function () {
        ...
        const contract = typechain_1.BalV2SpotPriceOracle__factory.connect(
            oracleDeployment.address,
            signer
        );
