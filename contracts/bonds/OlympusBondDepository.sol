...
contract OlympusBondDepository is Policy {
    ...
    function deposit(
        ...
        uint256 value = IOlympusTreasury(treasury).valueOf(principle, _amount);
        ...
        IOlympusTreasury(treasury).deposit(_amount, principle, profit);
    ...
    function _bondPrice() internal returns (uint256 price_) {
        price_ = (terms.controlVariable * debtRatio() + 1_000_000_000) / 1e7;
        if (price_ < terms.minimumPrice) {
            price_ = terms.minimumPrice;
