...
contract MockBaseStrategy is BaseStrategy {
    ...
    function _emergencyWithdrawTo(address _token, address _to) internal override returns (uint256){
        return 0;
    }
    ...
    function _collectRewards(address _token, address _to) internal override returns (address[] memory){
        return new address[](0);
    }

    function _exit(address _token) internal override{}

    function balance(address _token) external override view returns (uint256){
        return 0;
    }
}
